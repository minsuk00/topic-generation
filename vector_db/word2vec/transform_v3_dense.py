...
def save_as_json(works_id_vector_json, offset: int):
    with open(f"vectors/dense/batch_{offset}.json", "w", encoding="utf-8") as fp:
...
def main():
    logging.basicConfig(filename="v3_dense.log", encoding="utf-8", level=logging.INFO)
    ...
    emb = Specter2EmbedderAugRefresh(Accelerator())
